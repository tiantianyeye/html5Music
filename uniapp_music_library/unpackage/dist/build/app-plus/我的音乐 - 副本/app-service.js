...
__wxAppCode__['app.json']={"pages":["pages/music/index","pages/me/index","pages/musicplayer/index","pages/books/index","pages/comments/index","pages/detail/index"],"window":{"navigationBarTitleText":"我的音乐","navigationBarBackgroundColor":"#1AA034","backgroundColor":"#1AA034"},"tabBar":{"color":"#333333","selectedColor":"#1AA034","borderStyle":"black","list":[{"text":"音乐","pagePath":"pages/music/index","iconPath":"static/img/music.png","selectedIconPath":"static/img/music_hl.png"},{"text":"图书","pagePath":"pages/books/index","iconPath":"static/img/book.png","selectedIconPath":"static/img/book-active.png"},{"text":"个人中心","pagePath":"pages/me/index","iconPath":"static/img/yuedu.png","selectedIconPath":"static/img/yuedu_hl.png"}]},"networkTimeout":{},"debug":false,"functionalPages":false,"subPackages":[],"workers":"","preloadRule":{},"requiredBackgroundModes":[],"plugins":{},"resizable":false,"navigateToMiniProgramAppIdList":[],"usingComponents":{}};
...
__wxRoute = 'pages/books/index';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/books/index.js';

define('pages/books/index.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
require("../../common/manifest.js");
require("../../common/vendor.js");
global.webpackJsonp([1],{41:function(t,e,o){"use strict";var r=a(o(2)),i=a(o(42));function a(t){return t&&t.__esModule?t:{default:t}}Page((0,r.default)(i.default))},42:function(t,e,o){"use strict";Object.defineProperty(e,"__esModule",{value:!0});var r=o(44),i=o.n(r),a=o(56);var n=function(t){o(43)},s=o(0)(i.a,a.a,n,null,null);e.default=s.exports},43:function(t,e){},44:function(t,e,o){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0});var r=o(3),i=o(4),a=u(o(45)),n=u(o(52)),s=u(o(7));function u(t){return t&&t.__esModule?t:{default:t}}function c(t){if(Array.isArray(t)){for(var e=0,o=Array(t.length);e<t.length;e++)o[e]=t[e];return o}return Array.from(t)}e.default={data:function(){return{userInfo:{},books:[],currentPage:1,pages:0,more:!0}},components:{MyCard:a.default,TopSwiper:n.default,MyNoMore:s.default},methods:{getList:function(){var e=this;t.showNavigationBarLoading(),this.more=!0,(0,r.get)(i.bookListUrl,{currentPage:e.currentPage},!0).then(function(o){var r=o.data;e.books=[].concat(c(e.books),c(r.result)),e.pages=r.pages,e.currentPage>=r.pages?e.more=!1:e.currentPage++,t.stopPullDownRefresh(),t.hideNavigationBarLoading()})}},created:function(){t.getStorageSync("userInfo");this.getList()},onPullDownRefresh:function(){this.currentPage=1,this.pages=0,this.books=[],this.getList()},onReachBottom:function(){this.more&&this.getList()}}}).call(e,o(1).default)},45:function(t,e,o){"use strict";Object.defineProperty(e,"__esModule",{value:!0});var r=o(47),i=o.n(r),a=o(51);var n=function(t){o(46)},s=o(0)(i.a,a.a,n,"data-v-0476657c",null);e.default=s.exports},46:function(t,e){},47:function(t,e,o){"use strict";Object.defineProperty(e,"__esModule",{value:!0});var r,i=o(8),a=(r=i)&&r.__esModule?r:{default:r};e.default={data:function(){return{}},props:["book"],computed:{detailUrl:function(){return"/pages/detail/index?isbn="+this.book.ISBN}},created:function(){var t=this.book.rate;this.book.rate=t.toString().length>1?t:t+".0"},components:{MyRate:a.default},methods:{previewImage:function(){wx.previewImage({current:this.book.imgUrl,urls:[this.book.imgUrl]})}}}},51:function(t,e,o){"use strict";var r={render:function(){var t=this,e=t.$createElement,o=t._self._c||e;return o("a",{attrs:{href:t.detailUrl}},[o("div",{staticClass:"book-card"},[o("div",{staticClass:"thumb"},[o("img",{staticClass:"image",attrs:{src:t.book.imgUrl,alt:"",mode:"aspectFit",eventid:"WeM-0"},on:{click:function(e){e.stopPropagation(),t.previewImage(e)}}})]),o("div",{staticClass:"detail"},[o("div",{staticClass:"row text-primary"},[o("div",{staticClass:"right"},[o("MyRate",{attrs:{value:t.book.rate,mpcomid:"m6X-0"}}),t._v(t._s(t.book.rate)+"\n                ")],1),o("div",{staticClass:"left bookname"},[t._v("\n                    "+t._s(t.book.bookname)+"\n                ")])]),o("div",{staticClass:"row"},[o("div",{staticClass:"right count"},[t._v("\n                    "+t._s(t.book.count)+"\n                ")]),o("div",{staticClass:"left author"},[t._v("\n                    "+t._s(t.book.author)+"\n                ")])]),o("div",{staticClass:"row"},[o("div",{staticClass:"right user"},[t._v("\n                    "+t._s(t.book.uploadPersonName)+"\n                ")]),o("div",{staticClass:"left"},[t._v("\n                    "+t._s(t.book.publisher)+"\n                ")])])])])])},staticRenderFns:[]};e.a=r},52:function(t,e,o){"use strict";Object.defineProperty(e,"__esModule",{value:!0});var r=o(54),i=o.n(r),a=o(55);var n=function(t){o(53)},s=o(0)(i.a,a.a,n,"data-v-6cd98186",null);e.default=s.exports},53:function(t,e){},54:function(t,e,o){"use strict";(function(t){Object.defineProperty(e,"__esModule",{value:!0});var r=o(4),i=o(3);e.default={data:function(){return{imgUrls:[]}},mounted:function(){this.getTop()},methods:{bookDetail:function(e){var o="/pages/detail/index?isbn="+e.ISBN;t.navigateTo({url:o})},getTop:function(){var t=this;(0,i.get)(r.bookTopUrl).then(function(e){t.imgUrls=[e.slice(0,3),e.slice(3,6),e.slice(6,9)]},!0)}}}}).call(e,o(1).default)},55:function(t,e,o){"use strict";var r={render:function(){var t=this,e=t.$createElement,o=t._self._c||e;return o("div",{staticClass:"swiper-div"},[o("swiper",{attrs:{"indicator-dots":"true","indicator-color":"#EA5A49",autoplay:"true",interval:"5000",duration:"600",circular:"true"}},t._l(t.imgUrls,function(e,r,i){return o("block",{key:i},[o("swiper-item",{attrs:{mpcomid:"QVx-0-"+r}},t._l(e,function(e,i,a){return o("img",{key:a,staticClass:"slide-image",attrs:{mode:"aspectFit",src:e.imgUrl,eventid:"dXn-0-"+r+"-"+i},on:{click:function(o){t.bookDetail(e)}}})}))],1)}))],1)},staticRenderFns:[]};e.a=r},56:function(t,e,o){"use strict";var r={render:function(){var t=this.$createElement,e=this._self._c||t;return e("div",{staticClass:"book-div"},[e("TopSwiper",{attrs:{mpcomid:"ZZB-0"}}),this._l(this.books,function(t,o,r){return e("MyCard",{key:o,attrs:{book:t,mpcomid:"3zr-1-"+o}})}),e("MyNoMore",{attrs:{toShow:!this.more,mpcomid:"DBu-2"}})],2)},staticRenderFns:[]};e.a=r}},[41]);
});
require('pages/books/index.js');
__wxRoute = 'pages/comments/index';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/comments/index.js';

define('pages/comments/index.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
require("../../common/manifest.js");
require("../../common/vendor.js");
...
require('pages/comments/index.js');

...
__wxAppCode__['app.json']={"pages":["pages/music/index","pages/me/index","pages/musicplayer/index"],"window":{"navigationBarTitleText":"我的音乐","navigationBarBackgroundColor":"#1AA034","backgroundColor":"#1AA034"},"tabBar":{"color":"#333333","selectedColor":"#1AA034","borderStyle":"black","list":[{"text":"音乐","pagePath":"pages/music/index","iconPath":"static/img/music.png","selectedIconPath":"static/img/music_hl.png"},{"text":"个人名片","pagePath":"pages/me/index","iconPath":"static/img/yuedu.png","selectedIconPath":"static/img/yuedu_hl.png"}]},"networkTimeout":{},"debug":false,"functionalPages":false,"subPackages":[],"workers":"","preloadRule":{},"requiredBackgroundModes":[],"plugins":{},"resizable":false,"navigateToMiniProgramAppIdList":[],"usingComponents":{}};
...
require("../../common/manifest.js");
require("../../common/vendor.js");
global.webpackJsonp([4],{27:function(e,t,n){"use strict";var u=r(n(4)),a=r(n(28));function r(e){return e&&e.__esModule?e:{default:e}}Page((0,u.default)(a.default))},28:function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var u=n(30),a=n.n(u),r=n(31);var c=function(e){n(29)},i=n(0)(a.a,r.a,c,"data-v-0f5c5fe2",null);t.default=i.exports},29:function(e,t){},30:function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default={data:function(){return{}},methods:{}}},31:function(e,t,n){"use strict";var u={render:function(){var e=this.$createElement;return(this._self._c||e)("view",[this._v("我的")])},staticRenderFns:[]};t.a=u}},[27]);
});
require('pages/me/index.js');
__wxRoute = 'pages/musicplayer/index';__wxRouteBegin = true;__wxAppCurrentFile__ = 'pages/musicplayer/index.js';

define('pages/musicplayer/index.js',function(require, module, exports, window, document, frames, self, location, navigator, localStorage, history, Caches, screen, alert, confirm, prompt, fetch, XMLHttpRequest, WebSocket, webkit, WeixinJSCore, Reporter, print, WeixinJSBridge){
require("../../common/manifest.js");
require("../../common/vendor.js");
global.webpackJsonp([3],{32:function(t,i,n){"use strict";var e=o(n(4)),s=o(n(33));function o(t){return t&&t.__esModule?t:{default:t}}Page((0,e.default)(s.default))},33:function(t,i,n){"use strict";Object.defineProperty(i,"__esModule",{value:!0});var e=n(35),s=n.n(e),o=n(36);var a=function(t){n(34)},r=n(0)(s.a,o.a,a,"data-v-1739ef05",null);i.default=r.exports},34:function(t,i){},35:function(t,i,n){"use strict";(function(t){Object.defineProperty(i,"__esModule",{value:!0});var e=Object.assign||function(t){for(var i=1;i<arguments.length;i++){var n=arguments[i];for(var e in n)Object.prototype.hasOwnProperty.call(n,e)&&(t[e]=n[e])}return t},s=n(3),o=n(5),a=n(6);i.default={data:function(){return{songDetail:"",chooseIndex:0,currentTime:0,currentSecond:0,dealTotalTime:0,bgAudioMannager:"",topDistance:0}},onShow:function(){this.chooseIndex=this.$root.$mp.query.index;t.setNavigationBarTitle({title:this.musicDetailInfo.audio_name}),this.bgAudioMannager=this.globalData.bgAudioMannager,this.dealTotalTime=(0,o.secondToMinute)(this.musicDetailInfo.timelength),this.setBgMusic(),this.setMusicMonitor()},computed:e({},(0,s.mapGetters)(["songList","musicDetailInfo","isPlaying"]),{dealCurrentTime:function(){return(0,o.secondToMinute)(this.currentTime)},computeCurrentSecond:function(){var t=this,i=Math.round(this.currentTime/1e3);return i>4&&i!=this.currentSecond&&(t.currentSecond=i,this.lyricsArr.timeArrs.forEach(function(i,n){i!=t.currentSecond||(t.topDistance=-25*(n-4))})),i},currentPrecent:function(){return this.dealCurrentTime?Math.round(100*this.currentTime/this.musicDetailInfo.timelength):0},lyricsArr:function(){var t=[],i=[];return this.musicDetailInfo.lyrics.split("[").slice(1).map(function(n,e){var s=(n=n.trim().split("]"))[0].split(":"),o=60*Number(s[0])+Number(s[1].split(".")[0]);t.push(o),i.push(n[1])}),{timeArrs:t,lyricsList:i}}}),methods:{setBgMusic:function(){var t=this.musicDetailInfo;this.bgAudioMannager.title=t.song_name,this.bgAudioMannager.singer=t.author_name,this.bgAudioMannager.coverImgUrl=t.img,this.bgAudioMannager.src=t.play_url},getSongDetailInfo:function(t){var i=this;i.chooseIndex=t;var n=i.songList[t].FileHash;(0,o.get)(a.playUrl,{r:"play/getdata",hash:n}).then(function(t){i.$store.dispatch("setSongDetailInfo",t),i.playMusic()})},playMusic:function(){this.$store.dispatch("setMusicPlay");var t=this.musicDetailInfo;this.bgAudioMannager.stop(),this.bgAudioMannager.title=t.song_name,this.bgAudioMannager.singer=t.author_name,this.bgAudioMannager.coverImgUrl=t.img,this.bgAudioMannager.src=t.play_url,this.bgAudioMannager.play()},prevSong:function(){var t=this.chooseIndex-1;t=t<0?0:t,this.getSongDetailInfo(t)},nextSong:function(){var t=this.chooseIndex+1;t=t>=this.songList.length?0:t,this.getSongDetailInfo(t)},onMusicTap:function(){this.isPlaying?(this.bgAudioMannager.pause(),this.$store.dispatch("setMusicPause")):(this.bgAudioMannager.play(),this.$store.dispatch("setMusicPlay"))},setMusicMonitor:function(){var t=this;this.bgAudioMannager.onPlay(function(){t.$store.dispatch("setMusicPlay")}),this.bgAudioMannager.onPause(function(){t.$store.dispatch("setMusicPause")}),this.bgAudioMannager.onPrev(function(){t.prevSong()}),this.bgAudioMannager.onNext(function(){t.nextSong()}),this.bgAudioMannager.onTimeUpdate(function(){t.currentTime=1e3*t.bgAudioMannager.currentTime}),this.bgAudioMannager.onEnded(function(){t.$store.dispatch("setMusicPause");var i=t.chooseIndex+1;i=i>=t.songList.length?0:i,t.chooseIndex=i,t.getSongDetailInfo(i)})},downloadSong:function(){var i=this.musicDetailInfo.play_url;t.downloadFile({url:i,success:function(i){console.log(i);var n=i.tempFilePath;t.saveFile({tempFilePath:n,success:function(t){var i=t.savedFilePath;console.log(i),(0,o.showToast)("下载成功\n路径:"+i)},fail:function(){(0,o.showToast)("下载失败，请重试")}})},fail:function(){(0,o.showToast)("下载失败，请重试")}})}}}}).call(i,n(1).default)},36:function(t,i,n){"use strict";var e={render:function(){var t=this,i=t.$createElement,n=t._self._c||i;return n("div",{staticClass:"musicplayer-div"},[n("image",{staticClass:"bgImg",attrs:{src:t.musicDetailInfo.img}}),n("div",{staticClass:"music-div"},[n("div",{staticClass:"geci-div"},[n("div",{staticClass:"pos-div",style:{top:t.topDistance+"px"}},t._l(t.lyricsArr.lyricsList,function(i,e,s){return n("p",{key:s,class:{active:e<t.lyricsArr.lyricsList.length-1?t.computeCurrentSecond>3&&t.computeCurrentSecond>=t.lyricsArr.timeArrs[e]&&t.computeCurrentSecond<=t.lyricsArr.timeArrs[e+1]:t.computeCurrentSecond>t.lyricsArr.timeArrs[e]}},[t._v("\n\t\t\t\t\t"+t._s(i)+"\n\t\t\t\t")])}))])]),n("div",{staticClass:"controls-group-div"},[n("div",{staticClass:"progress-div"},[n("span",[t._v(t._s(t.dealCurrentTime))]),n("progress",{attrs:{percent:t.currentPrecent,"stroke-width":"5",backgroundColor:"#dcdcdc",activeColor:"#3195fd"}}),n("span",[t._v(t._s(t.dealTotalTime))])],1),n("div",{staticClass:"control-div"},[n("div",{staticClass:"space"}),n("div",{staticClass:"control-btn"},[n("i",{staticClass:"iconfont icon-kuaijin-copy",attrs:{eventid:"MIG-0"},on:{click:function(i){i.stopPropagation(),t.prevSong(i)}}}),n("i",{staticClass:"iconfont icon-Icon-pause",class:[t.isPlaying?"icon-Icon-pause":"icon-zanting"],attrs:{eventid:"WNh-1"},on:{click:function(i){i.stopPropagation(),t.onMusicTap(i)}}}),n("i",{staticClass:"iconfont icon-kuaijin",attrs:{eventid:"hZJ-2"},on:{click:function(i){i.stopPropagation(),t.nextSong(i)}}})],1),n("i",{staticClass:"iconfont icon-xiazai download",attrs:{eventid:"Nwh-3"},on:{click:function(i){i.stopPropagation(),t.downloadSong(i)}}})],1)])])},staticRenderFns:[]};i.a=e}},[32]);
});
require('pages/musicplayer/index.js');
